...
👋 Hi, I'm Boris Leclere, a passionate software craftsman and freelance CTO/Tech Lead.

🔧 I specialize in custom Python & C# development: scripts, bots, internal tools, libraries, and console applications. I love automating workflows, integrating APIs, and building robust solutions for data processing and business needs.

🎯 **What I offer:**
- 🐍 **Custom Python & C# development:** Scripts, bots, internal tools, libraries, automation, API integration, data transformation.
- 🏗️ **Software architecture & tooling:** Design or refactoring of robust solutions (desktop apps, business tools, services), modular development, project structuring, industrialization of deliverables.
- 📦 **Dockerization & CI/CD:** Containerization with Docker & Docker Compose, automated testing, continuous deployment with GitHub Actions, monitoring with Portainer.
- 👨‍💻 **Freelance CTO / External Tech Lead:** Strategic and technical guidance, architecture choices, technical mentoring, code audits, product roadmap.

🚀 **Specialties:**  
C# .NET, Python, console applications, internal libraries, automation, Docker, GitHub Actions, scripting, AI-driven development, mobile & embedded systems.

---

🧡 *"The only way to do great work is to love what you do."* – Steve Jobs  
🌍 *"The journey is as important as the destination."* – Confucius

My journey began in the early 90s with my first computer, an ICL DRS M30. After 6 years in electrical engineering and discovering C on robotics projects, I participated in the French Robotics Cup.  
For over 14 years, I have been building my expertise as a developer and CTO. Today, I bring this experience to my clients as a freelance consultant.
...
- [**FFBBApiClientV2_Python**](https://github.com/Rinzler78/FFBBApiClientV2_Python)  
  🏀 Python client to interact with the new FFBB APIs (French Basketball Federation).  
  _Retrieve and process data about clubs, teams, matches, and more. Designed for automation, data analysis, and integration with external systems._  
  <sub>PyPI package, full documentation, and CI/CD included.</sub>

- [**docker.idena-node**](https://github.com/Rinzler78/docker.idena-node)  
  🐳 Dockerized solution for running an Idena blockchain node.  
  _Easily deploy and manage your Idena node with Docker and Shell scripts. Includes monitoring and update automation._  
  <sub>Used by the crypto community for reliable node management.</sub>

- [**aioz-node-docker**](https://github.com/Rinzler78/aioz-node-docker)  
  🌐 Docker image for AIOZ blockchain node deployment.  
